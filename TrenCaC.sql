...
insert into usuarios (nombre, apellido, fechaNac, pais , email, username, password) values
('Iraida', 'Perez', '15-07-1976', 'Venezuela', 'iraidap@proyecto.com', 'iraidap', '1234');
